...
//            Map<String, Object> userInfo = oidcService.fetchUserInfo(accessToken);
//            Authentication authReq = new UsernamePasswordAuthenticationToken(userInfo.get("preferred_username"), null);
...
//
//            return ResponseEntity.status(HttpStatus.OK).body("User authenticated and session created");
//
